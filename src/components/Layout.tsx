import {
  ...
  FileText, Gavel, GitBranch, GraduationCap, Home, Inbox, Library, Menu, Moon, NotebookPen,
  Scale, ShieldCheck, Sun, X,
} from "lucide-react";
import { useState } from "react";

export type Page = "dashboard" | "assistant" | "academy" | "learn" | "paragraphs" | "schemas" | "decisions" | "cases" | "quiz" | "documents" | "sources" | "plan" | "cards" | "templates" | "notes" | "exam";
...
const items: { id: Page; label: string; short: string; icon: typeof Home }[] = [
  ...
  { id: "paragraphs", label: "Paragraphenbibliothek", short: "§§", icon: Gavel },
...
const mobileItems = items.filter((item) => ["dashboard", "learn", "paragraphs", "cases", "quiz"].includes(item.id));
